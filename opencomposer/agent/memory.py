...
from opencomposer.utils.helpers import ensure_dir, estimate_message_tokens, estimate_prompt_tokens_chain, strip_think

from opencomposer.agent.runner import AgentRunSpec, AgentRunner
from opencomposer.agent.tools.registry import ToolRegistry
from opencomposer.utils.gitstore import GitStore
...
class Dream:
    ...
    def _build_tools(self) -> ToolRegistry:
        ...
        from opencomposer.agent.tools.filesystem import EditFileTool, ReadFileTool
