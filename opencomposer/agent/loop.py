...
from opencomposer.utils.helpers import image_placeholder_text, truncate_text
from opencomposer.utils.runtime import EMPTY_FINAL_RESPONSE_MESSAGE

if TYPE_CHECKING:
    from opencomposer.config.schema import ChannelsConfig, ExecToolConfig, WebToolsConfig
...
class _LoopHook(AgentHook):
    ...
    async def on_stream(self, context: AgentHookContext, delta: str) -> None:
        from opencomposer.utils.helpers import strip_think
...
class AgentLoop:
    ...
    def __init__(
        ...
        # OPENCOMPOSER_MAX_CONCURRENT_REQUESTS: <=0 means unlimited; default 3.
        _max = int(os.environ.get("OPENCOMPOSER_MAX_CONCURRENT_REQUESTS", "3"))
    ...
    async def _connect_mcp(self) -> None:
        ...
        from opencomposer.agent.tools.mcp import connect_mcp_servers
        try:
