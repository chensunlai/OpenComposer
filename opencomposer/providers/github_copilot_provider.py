...
TOKEN_APP_NAME = "opencomposer"
USER_AGENT = "opencomposer/0.1"
...
class GitHubCopilotProvider(OpenAICompatProvider):
    ...
    async def _get_copilot_access_token(self) -> str:
        ...
        if not github_token or not github_token.access:
            raise RuntimeError("GitHub Copilot is not logged in. Run: opencomposer provider login github-copilot")
