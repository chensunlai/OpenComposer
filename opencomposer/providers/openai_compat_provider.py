...
from opencomposer.providers.base import LLMProvider, LLMResponse, ToolCallRequest

if TYPE_CHECKING:
    from opencomposer.providers.registry import ProviderSpec
...
_DEFAULT_OPENROUTER_HEADERS = {
    "HTTP-Referer": "https://github.com/HKUDS/opencomposer",
    "X-OpenRouter-Title": "opencomposer",
...
def _uses_openrouter_attribution(spec: "ProviderSpec | None", api_base: str | None) -> bool:
    """Apply Opencomposer attribution headers to OpenRouter requests by default."""
...
class OpenAICompatProvider(LLMProvider):
    ...
    async def chat_stream(
        ...
        idle_timeout_s = int(os.environ.get("OPENCOMPOSER_STREAM_IDLE_TIMEOUT_S", "90"))
        try:
