...
try:
    ...
    raise ImportError(
        "Matrix dependencies not installed. Run: pip install opencomposer-ai[matrix]"
    ) from e
...
from opencomposer.config.paths import get_data_dir, get_media_dir
from opencomposer.config.schema import Base
from opencomposer.utils.helpers import safe_filename
