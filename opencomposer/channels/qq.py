...
- Publish to Opencomposer bus via BaseChannel._handle_message()
...
from opencomposer.security.network import validate_url_target
...
def _make_bot_class(channel: QQChannel) -> type[botpy.Client]:
    ...
    class _Bot(botpy.Client):
        def __init__(self):
            # Disable botpy's file log — opencomposer uses loguru; default "botpy.log" fails on read-only fs
...
class QQConfig(Base):
    ...
    # Optional: directory to save inbound attachments. If empty, use opencomposer get_media_dir("qq").
    media_dir: str = ""
