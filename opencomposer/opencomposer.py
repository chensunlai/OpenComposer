"""High-level programmatic interface to opencomposer."""
...
from opencomposer.agent.hook import AgentHook
...
class Opencomposer:
    """Programmatic facade for running the opencomposer agent.

    Usage::

        bot = Opencomposer.from_config()
    ...
    def from_config(
        ...
        *,
        ...
        """Create a Opencomposer instance from a config file.
