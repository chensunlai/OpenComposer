...
This directory contains built-in skills that extend opencomposer's capabilities.
...
When skills reference large local documentation or logs, prefer opencomposer's built-in
...
| `task-manager` | Decide when to create, split, delegate, and clean up session tasks |
