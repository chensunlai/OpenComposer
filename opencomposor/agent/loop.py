...
from opencomposor.agent.memory import Consolidator, Dream
from opencomposor.agent.runner import AgentRunSpec, AgentRunner
from opencomposor.agent.subagent import SubagentManager
from opencomposor.agent.tools.cron import CronTool
from opencomposor.agent.skills import BUILTIN_SKILLS_DIR
from opencomposor.agent.tools.filesystem import EditFileTool, ListDirTool, ReadFileTool, WriteFileTool
from opencomposor.agent.tools.message import MessageTool
from opencomposor.agent.tools.registry import ToolRegistry
from opencomposor.agent.tools.search import GlobTool, GrepTool
from opencomposor.agent.tools.shell import ExecTool
from opencomposor.agent.tools.spawn import SpawnTool
from opencomposor.agent.tools.web import WebFetchTool, WebSearchTool
from opencomposor.bus.events import InboundMessage, OutboundMessage
from opencomposor.command import CommandContext, CommandRouter, register_builtin_commands
from opencomposor.bus.queue import MessageBus
from opencomposor.config.schema import AgentDefaults
from opencomposor.providers.base import LLMProvider
from opencomposor.session.manager import Session, SessionManager
from opencomposor.utils.helpers import image_placeholder_text, truncate_text
from opencomposor.utils.runtime import EMPTY_FINAL_RESPONSE_MESSAGE

if TYPE_CHECKING:
    from opencomposor.config.schema import ChannelsConfig, ExecToolConfig, WebToolsConfig
...
class _LoopHook(AgentHook):
    ...
    async def on_stream(self, context: AgentHookContext, delta: str) -> None:
        from opencomposor.utils.helpers import strip_think
...
class AgentLoop:
    ...
    def __init__(
        ...
        from opencomposor.config.schema import ExecToolConfig, WebToolsConfig
        ...
        # OPENCOMPOSOR_MAX_CONCURRENT_REQUESTS: <=0 means unlimited; default 3.
        _max = int(os.environ.get("OPENCOMPOSOR_MAX_CONCURRENT_REQUESTS", "3"))
    ...
    async def _connect_mcp(self) -> None:
        ...
        from opencomposor.agent.tools.mcp import connect_mcp_servers
        try:
