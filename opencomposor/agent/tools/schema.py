"""JSON Schema fragment types: all subclass :class:`~opencomposor.agent.tools.base.Schema` for descriptions and constraints on tool parameters.

- ``to_json_schema()``: returns a dict compatible with :meth:`~opencomposor.agent.tools.base.Schema.validate_json_schema_value` /
  :class:`~opencomposor.agent.tools.base.Tool`.
...
Shared validation and fragment normalization are on the class methods of :class:`~opencomposor.agent.tools.base.Schema`.
...
from opencomposor.agent.tools.base import Schema
