...
from opencomposor.providers.base import LLMProvider, LLMResponse, ToolCallRequest

if TYPE_CHECKING:
    from opencomposor.providers.registry import ProviderSpec
...
_DEFAULT_OPENROUTER_HEADERS = {
    "HTTP-Referer": "https://github.com/HKUDS/opencomposor",
    "X-OpenRouter-Title": "opencomposor",
...
def _uses_openrouter_attribution(spec: "ProviderSpec | None", api_base: str | None) -> bool:
    """Apply Opencomposor attribution headers to OpenRouter requests by default."""
...
class OpenAICompatProvider(LLMProvider):
    ...
    async def chat_stream(
        ...
        idle_timeout_s = int(os.environ.get("OPENCOMPOSOR_STREAM_IDLE_TIMEOUT_S", "90"))
        try:
