...
This directory contains built-in skills that extend opencomposor's capabilities.
...
When skills reference large local documentation or logs, prefer opencomposor's built-in
