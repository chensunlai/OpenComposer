...
try:
    ...
    raise ImportError(
        "Matrix dependencies not installed. Run: pip install opencomposor-ai[matrix]"
    ) from e
...
from opencomposor.config.paths import get_data_dir, get_media_dir
from opencomposor.config.schema import Base
from opencomposor.utils.helpers import safe_filename
