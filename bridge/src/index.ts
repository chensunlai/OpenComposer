 ...
 *   BRIDGE_PORT=3001 AUTH_DIR=~/.composer/whatsapp npm start
 */
...
const AUTH_DIR = process.env.AUTH_DIR || join(homedir(), '.composer', 'whatsapp-auth');
...
console.log('♾️ opencomposer WhatsApp Bridge');
console.log('========================\n');
